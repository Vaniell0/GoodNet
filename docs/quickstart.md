...
См. также: [Сборка (подробно)](data/projects/GoodNet/docs/build.md) · [Конфигурация](data/projects/GoodNet/docs/config.md) · [Обзор архитектуры](data/projects/GoodNet/docs/architecture.md)
...
Подробнее: [Сборка](data/projects/GoodNet/docs/build.md) — опции CMake, пресеты, Docker CI, почему SHARED.
...
Сервер принимает TCP (или ICE) соединения, автоматически выполняет [Noise_XX handshake](data/projects/GoodNet/docs/protocol/noise-handshake.md), и слушает пакеты.
...
- `dec_fail` — ошибки дешифрации ([ChaChaPoly-IETF AEAD](data/projects/GoodNet/docs/protocol/crypto.md#aead-шифрование))
- `drops` — сброшенные пакеты ([backpressure, overflow](data/projects/GoodNet/docs/architecture/signal-bus.md#stats))
...
| `-c, --config PATH` | JSON [конфигурация](data/projects/GoodNet/docs/config.md) |
...
**Причины и решения:**
1. **Handshake timeout** — [Noise_XX](data/projects/GoodNet/docs/protocol/noise-handshake.md) handshake завершается за 30s. Проверьте network latency:
   ```bash
...
**Причины:**
1. **Key mismatch** — пиры используют разные [identity keys](data/projects/GoodNet/docs/protocol/crypto.md#ключи). Проверьте:
   ```bash
...
2. **Permissions на identity.dir** — процесс не может прочитать ключи:
   ...
   ```
3. **[Cross-verification](data/projects/GoodNet/docs/protocol/noise-handshake.md#cross-verification) failed** — device_pk не совпадает с Noise static key. Возможна подмена или ошибка деривации.
...
Подробнее: [Система плагинов](data/projects/GoodNet/docs/architecture/plugin-system.md#загрузка-плагинов).
...
Полный справочник: [Конфигурация](data/projects/GoodNet/docs/config.md).
...
Подробнее: [Handler: гайд](data/projects/GoodNet/docs/guides/handler-guide.md).
...
**См. также:** [Сборка](data/projects/GoodNet/docs/build.md) · [Конфигурация](data/projects/GoodNet/docs/config.md) · [Обзор архитектуры](data/projects/GoodNet/docs/architecture.md) · [Handler: гайд](data/projects/GoodNet/docs/guides/handler-guide.md)
